...
(() => {
  ...
  function filterFeed(type) {
    ...
    pages.forEach(
      (page) => {
        ...
        /*
         * Keep pages mounted so that
         * the video engine remains stable.
         */
  ...
  function initializeZYLO() {
    /*
     * Load authentication bridge.
     */

    loadAuthJS();

    /*
     * Restore videos uploaded

/* =========================================================
   ZYLO v1012 - COMPLETE FRONTEND ENGINE
...
(() => {
    ...
    function attachEndedHandler(video) {
      ...
      video.addEventListener(
        ...
        () => {
          ...
          const currentPage =
            currentVideo.closest(".video-page");
  ...
  function showCreatorProfile(page) {
    ...
    if (!panel) {
      ...
      $(".zylo-profile-follow", panel)?.addEventListener(
        ...
        () => {
          const follows =
            getStorage(CONFIG.STORAGE.FOLLOWS, []);
  ...
  function restoreUploadedVideos() {
     ...
     *
     * This prevents broken/empty video cards
     * from being inserted after a page refresh.
     *
